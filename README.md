...
![License](https://img.shields.io/github/license/hadiprasetiyo/violence-district-script?style=for-the-badge)
...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/Rzor731/VD-AUTO-FARM/refs/heads/main/loader.lua"))()
```
