...
--==================================================
-- BEAT SURVIVOR STATE & FARM STATS TRACKER
--==================================================
...
--==================================================
-- SERVER HOP & IGNORED SERVERS SYSTEM
--==================================================
...
--==================================================
-- SERVER HOP STATE & ROUND DETECTORS
--==================================================
...
TestNotificationGroup:AddButton("1. Simple", function()
    Library:Notify({ Title = "Server Hop", Description = "Simple notification", Time = 4 })
end)

TestNotificationGroup:AddButton("2. Icon", function()
    Library:Notify({ Title = "Server Hop", Description = "Notification with an icon", Icon = "info", Time = 4 })
end)
